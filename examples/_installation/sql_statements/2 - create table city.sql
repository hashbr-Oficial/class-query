CREATE TABLE IF NOT EXISTS `class_Query`.`city` (
...
INSERT INTO `class_Query`.`city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
...
(20, 'Å½s-Hertogenbosch', 'NLD', 'Noord-Brabant', 129170),
...
(63, 'Saint JohnÅ½s', 'ATG', 'St John', 24000),
...
(190, 'Saint George', 'BMU', 'Saint GeorgeÅ½s', 1800),
...
(330, 'Santa BÃ¡rbara dÅ½Oeste', 'BRA', 'SÃ£o Paulo', 171657),
...
(563, 'Rancagua', 'CHL', 'OÅ½Higgins', 212977),
...
(668, 'LÅ½Hospitalet de Llobregat', 'ESP', 'Katalonia', 247986),
...
(916, 'Saint GeorgeÅ½s', 'GRD', 'St George', 4621),
...
(1489, 'Reggio nellÅ½ Emilia', 'ITA', 'Emilia-Romagna', 143664),
...
(1851, 'Saint JohnÅ½s', 'CAN', 'Newfoundland', 101936),
...
(1901, 'XiÅ½an', 'CHN', 'Shaanxi', 2761400),
...
(1991, 'TaiÅ½an', 'CHN', 'Shandong', 350696),
...
(2005, 'MaÅ½anshan', 'CHN', 'Anhui', 305421),
...
(2065, 'BeiÅ½an', 'CHN', 'Heilongjiang', 204899),
...
(2128, 'RuiÅ½an', 'CHN', 'Zhejiang', 156468),
...
(2137, 'JiÅ½an', 'CHN', 'Jiangxi', 148583),
...
(2171, 'HuaiÅ½an', 'CHN', 'Jiangsu', 131149),
...
(3192, 'AraÅ½ar', 'SAU', 'al-Khudud al-Samaliy', 108100),
...
(3334, 'NukuÅ½alofa', 'TON', 'Tongatapu', 22400),
(3335, 'Chaguanas', 'TTO', 'Caroni', 56601),
(3336, 'Port-of-Spain', 'TTO', 'Port-of-Spain', 43396),
(3337, 'NÅ½DjamÃ©na', 'TCD', 'Chari-Baguirmi', 530965),
