...
## Requirements
-----------------
* **PHP 5.3.7+**, PHP 5.4+, PHP 5.5+ or PHP 7.2+
* **MySQL 5** database or **PostgreSQL 12+**
...
[documentation](http://getcomposer.org/doc/02-libraries.md).
    ...
    {
	"repositories": [
	    { "type": "git", "url": "https://github.com/hashbr-Oficial/class-query"}
	], 
        "require": {  
            "hashbr-Oficial/class-query": "dev-master"
        }
    }
    ```
...
https://github.com/hashbr-Oficial/class-query/issues?state=open
